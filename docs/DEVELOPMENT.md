...
- 房间网络：房间 1 到 6 分别使用 `10.222.1.0/24` 到 `10.222.6.0/24`。
...
|---|---:|---|
| 1 | 12001 | 10.222.1.0/24 |
| 2 | 12002 | 10.222.2.0/24 |
| 3 | 12003 | 10.222.3.0/24 |
| 4 | 12004 | 10.222.4.0/24 |
...
```text
ifconfig-push 10.222.<room>.<host> 255.255.255.0
```
